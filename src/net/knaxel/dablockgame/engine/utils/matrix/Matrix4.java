...
public class Matrix4 extends Matrix implements Serializable {
	...
	public static Vector4f transform(Matrix4 left, Vector4f right, Vector4f dest) {
		if (dest == null)
			dest = new Vector4f();
	...
	public Matrix4 translate(Vector2 vec) {
	...
	public Matrix4 translate(Vector2 vec, Matrix4 dest) {
		return translate(vec, this, dest);
	}

	
	public static Matrix4 translate(Vector2 vec, Matrix4 src, Matrix4 dest) {
		if (dest == null)
			dest = new Matrix4();
